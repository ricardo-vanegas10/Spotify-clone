  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="page__wrapper overflow-visible">
            ...
            <div className="home" ref={homeRef}>
              ...
              />
              <CardRowSection
                title="Las más escuchado por ti"
                data={top_user_tracks}
              />
              <CardRowSection
                title="Artistas más escuchados por ti"
                data={top_user_artists}
              />
              <CardRowSection title="Pop" data={top_genre_playlists} />
              <CardRowSection title="Humor" data={mood_category} />
              <CardRowSection
                title="Tops del momento"
                data={top_list_category}
              />
              <CardRowSection title="Lanzamientos" data={new_releases} />
            </div>
          </div>
        </>
      )}
